...
Item {
    ...
    states: [
        ...
        State {
            ...
            PropertyChanges {
                ...
                root.implicitHeight: Math.min(root.maxHeight, wallpaperList.item?.implicitHeight ?? root.Tokens.sizes.launcher.wallpaperHeight * 1.5)
    ...
    Row {
        ...
        opacity: root.currentList?.count === 0 && !root.search.text.startsWith(`${GlobalConfig.launcher.actionPrefix}clipboard `) ? 1 : 0
