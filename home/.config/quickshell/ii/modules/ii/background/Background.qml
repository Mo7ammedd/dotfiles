...
Variants {
    ...
    PanelWindow {
        ...
        Item {
            ...
            // Custom desktop widgets share the shell's live services.
            Loader {
                anchors.fill: parent
                z: 1
                active: Config.options.desktopWidgets.enable
                    && Config.options.desktopWidgets.showOnDesktop
                    && !GlobalStates.screenLocked
                sourceComponent: Desk.WidgetDeck {}
            }
            ...
            WidgetCanvas {
                ...
                FadeLoader {
                    shown: Config.options.background.widgets.weather.enable && !Config.options.desktopWidgets.enable
                ...
                FadeLoader {
                    shown: Config.options.background.widgets.clock.enable && (!Config.options.desktopWidgets.enable || GlobalStates.screenLocked)
